...
define(["require", "exports", "lodash/range", "lodash/isNil", "react", "./BaseCalendarView", "./Calendar", "./CalendarBody/Body", "./CalendarHeader/Header", "./DayView", "../lib"], function (require, exports, range_1, isNil_1, React, BaseCalendarView_1, Calendar_1, Body_1, Header_1, DayView_1, lib_1) {
    "use strict";
    ...
    var DatesRangeView = /** @class */ (function (_super) {
        ...
        DatesRangeView.prototype.render = function () {
            ...
            return (React.createElement(Calendar_1.default, __assign({ ref: function (e) { return (_this.calendarNode = lib_1.findHTMLElement(e)); }, outlineOnFocus: inline }, rest),
                ...
                React.createElement(Body_1.default, { width: DayView_1.DAY_CALENDAR_ROW_WIDTH, data: values, onCellClick: onValueClick, onCellHover: onCellHover, hovered: hoveredItemIndex, active: getActive(start, end), disabled: disabledItemIndexes, markColor: markColor, marked: markedItemIndexes, dots: dots })));
        };
