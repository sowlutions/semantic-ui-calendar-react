...
var DatesRangeView = /** @class */ (function (_super) {
    ...
    DatesRangeView.prototype.render = function () {
        ...
        return (React.createElement(Calendar, __assign({ ref: function (e) { return (_this.calendarNode = findHTMLElement(e)); }, outlineOnFocus: inline }, rest),
            ...
            React.createElement(Body, { width: DAY_CALENDAR_ROW_WIDTH, data: values, onCellClick: onValueClick, onCellHover: onCellHover, hovered: hoveredItemIndex, active: getActive(start, end), disabled: disabledItemIndexes, markColor: markColor, marked: markedItemIndexes, dots: dots })));
    };
