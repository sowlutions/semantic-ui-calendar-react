...
declare type ParseValueArrayData = object;
...
declare type parseArrayOfObjectsData = ParseValueArrayData;
/** Parse object[].
 *
 * Return array of objects in moment format. Object must be structures as such:
 * { ..., date: new Date(), ... }
 */
export declare function parseArrayOfObjects(data: parseArrayOfObjectsData, dateFormat: string, localization: string): any[];
