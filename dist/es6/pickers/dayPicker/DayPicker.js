...
import { buildDays, getDisabledDays, getMarkedDays, getDottedDays, getInitialDatePosition, isNextPageAvailable, isPrevPageAvailable, } from './sharedFunctions';
var PAGE_WIDTH = 7;
...
var DayPicker = /** @class */ (function (_super) {
    ...
    DayPicker.prototype.getDotsPositions = function () {
        /*
          Return position numbers of dates that should be displayed as marked
          (position in array returned by `this.buildCalendarValues`).
        */
