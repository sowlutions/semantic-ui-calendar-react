...
import BaseInput, { BaseInputProps, BaseInputState, DateRelatedProps, DisableValuesProps, EnableValuesProps, MinMaxValueProps, MultimodeProps, MarkedValuesProps, DottedProps } from './BaseInput';
declare type CalendarMode = 'year' | 'month' | 'day';
export interface DateInputProps extends BaseInputProps, DateRelatedProps, MultimodeProps, DisableValuesProps, EnableValuesProps, MarkedValuesProps, DottedProps, MinMaxValueProps {
...
declare class DateInput extends BaseInput<DateInputProps, DateInputState> {
    ...
    static readonly propTypes: {
        ...
        dots: PropTypes.Requireable<any[]>;
