...
var DayView = /** @class */ (function (_super) {
    ...
    DayView.prototype.render = function () {
        ...
        return (React.createElement(Calendar, __assign({ ref: function (e) { return (_this.calendarNode = findHTMLElement(e)); }, outlineOnFocus: inline }, rest),
            ...
            React.createElement(Body, { width: DAY_CALENDAR_ROW_WIDTH, data: values, hovered: hoveredItemIndex, onCellHover: onCellHover, onCellClick: onValueClick, active: activeItemIndex, disabled: disabledItemIndexes, marked: markedItemIndexes, markColor: markColor, dots: dots })));
    };
    return DayView;
}(BaseCalendarView));
