...
var DateTimeInput = /** @class */ (function (_super) {
    ...
    DateTimeInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, value = _a.value, dateTimeFormat = _a.dateTimeFormat, dateFormat = _a.dateFormat, timeFormat = _a.timeFormat, initialDate = _a.initialDate, disable = _a.disable, maxDate = _a.maxDate, minDate = _a.minDate, preserveViewMode = _a.preserveViewMode, startMode = _a.startMode, divider = _a.divider, closable = _a.closable, markColor = _a.markColor, marked = _a.marked, dots = _a.dots, localization = _a.localization, onChange = _a.onChange, disableMinute = _a.disableMinute, rest = __rest(_a, ["value", "dateTimeFormat", "dateFormat", "timeFormat", "initialDate", "disable", "maxDate", "minDate", "preserveViewMode", "startMode", "divider", "closable", "markColor", "marked", "dots", "localization", "onChange", "disableMinute"]);
    ...
    DateTimeInput.prototype.parseInternalValue = function () {
        ...
        */
        ...
        if (!isNil(year) || !isNil(month) || !isNil(date) || !isNil(hour) || !isNil(minute)) {
    ...
    DateTimeInput.prototype.getPicker = function () {
        ...
        if (mode === 'day') {
            return (React.createElement(DayPicker, __assign({}, pickerProps, { marked: markedParsed, markColor: markColor, dots: dotsParsed, disable: disableParsed })));
        }
        if (mode === 'hour') {
