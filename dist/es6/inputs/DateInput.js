...
import BaseInput, { BaseInputPropTypes, DateRelatedPropTypes, DisableValuesPropTypes, EnableValuesPropTypes, MinMaxValuePropTypes, MultimodePropTypes, MarkedValuesPropTypes, DottedPropTypes, } from './BaseInput';
...
var DateInput = /** @class */ (function (_super) {
    ...
    function DateInput(props) {
        ...
        _this.getPicker = function () {
            ...
            var dotsParsed = parseArrayOfObjects(dots, dateFormat, localization);
            ...
            return (React.createElement(DayPicker, __assign({}, pickerProps, { disable: disableParsed, marked: markedParsed, markColor: markColor, dots: dotsParsed })));
        };
    ...
    DateInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, value = _a.value, dateFormat = _a.dateFormat, initialDate = _a.initialDate, disable = _a.disable, enable = _a.enable, maxDate = _a.maxDate, minDate = _a.minDate, preserveViewMode = _a.preserveViewMode, startMode = _a.startMode, closable = _a.closable, markColor = _a.markColor, marked = _a.marked, dots = _a.dots, localization = _a.localization, onChange = _a.onChange, rest = __rest(_a, ["value", "dateFormat", "initialDate", "disable", "enable", "maxDate", "minDate", "preserveViewMode", "startMode", "closable", "markColor", "marked", "dots", "localization", "onChange"]);
    ...
    DateInput.propTypes = __assign({}, BaseInputPropTypes, DateRelatedPropTypes, MultimodePropTypes, DisableValuesPropTypes, EnableValuesPropTypes, MarkedValuesPropTypes, DottedPropTypes, MinMaxValuePropTypes, {
